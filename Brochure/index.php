...
<html>
	...
	<body>
		...
		<section class="mission content" id="mission">
			<div class="container">
		...
		<section class="mission parallax parallax-1">
			<div class="overlay">
				<div class="container vcenter-parent">
					<div class="vcenter">
						<h2 class="mission-heading">What can we do?</h2>
		...
		</section><!-- mission parallax parallax-1 -->
		...
		<section class="initiatives parallax parallax-2">
			<div class="overlay">
				<div class="container vcenter-parent">
					<div class="vcenter">
		...
		<section class="initiative live content">
			<div class="container">
				<span class="fa-stack fa-3x">
					<i class="fa fa-circle-thin fa-stack-2x"></i>
					<i class="fa fa-flask fa-stack-1x"></i>
			...
			<div class="container live">
				<p>A lively, interactive discussion about the ocean sciences presenting the science curriculum through the adventures of Dr. Leslie and her oceanographic colleagues. This sought-after show culmintates in a hands-on, inquiry-based demonstration of real oceanographic tools to analyze water samples and compare them to near-real time ocean data.</p>

			</div><!-- container live -->

		</section><!-- initiative live content -->


		<section class="initiative parallax parallax-3">
			<div class="overlay"></div>
		</section><!-- initiative parallax parallax-3 -->


		<section class="initiative interactive content">
			<div class="container">
				<span class="fa-stack fa-3x">
					<i class="fa fa-circle-thin fa-stack-2x"></i>
					<i class="fa fa-cube fa-stack-1x"></i>
			...
			</div><!-- container interactive -->

		</section><!-- initiative interactive content -->

		<section class="initiative parallax parallax-4">
			<div class="overlay"></div>
		</section><!-- initiative parallax parallax-4 -->


		<section class="initiative explore content">
			<div class="container">
				<span class="fa-stack fa-3x">
					<i class="fa fa-circle-thin fa-stack-2x"></i>
					<i class="fa fa-ship fa-stack-1x"></i>
		...
		</section><!-- initiative explore content -->

		<section class="initiative parallax parallax-5">
			<div class="overlay"></div>
		</section><!-- initiative parallax parallax-5 -->
